...
function generateDecimalEntries(): DecimalToFractionEntry[] {
  const decimals: [number, number, number][] = [
    [0.0625, 1, 16], [0.1, 1, 10], [0.125, 1, 8], [0.15, 3, 20],
    [0.1875, 3, 16], [0.2, 1, 5], [0.25, 1, 4], [0.3, 3, 10],
    [0.3125, 5, 16], [0.333, 1, 3], [0.35, 7, 20], [0.375, 3, 8],
    [0.4, 2, 5], [0.4375, 7, 16], [0.45, 9, 20], [0.5, 1, 2],
    [0.5625, 9, 16], [0.55, 11, 20], [0.6, 3, 5], [0.625, 5, 8],
    [0.65, 13, 20], [0.666, 2, 3], [0.6875, 11, 16], [0.7, 7, 10],
    [0.75, 3, 4], [0.8, 4, 5], [0.8125, 13, 16], [0.825, 33, 40],
    [0.85, 17, 20], [0.875, 7, 8], [0.9, 9, 10], [0.9375, 15, 16],
    [0.95, 19, 20], [1.25, 5, 4], [1.5, 3, 2], [1.75, 7, 4],
    [2.5, 5, 2], [3.5, 7, 2],
  ]
